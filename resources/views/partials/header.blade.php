    ...
    <div class="header-section header-white-nav-links bg-dark-1">
        <div id="logoAndNav" class="container px-md-6 px-xl-7 px-wd-6">
            ...
            <nav class="js-mega-menu navbar navbar-expand-xl py-0 position-static justify-content-start">
                ...
                <!-- Logo -->
                <a class="navbar-brand w-auto mr-xl-5 mr-wd-8" href="../home/index.html">
                    ...
                    <div class="d-inline-flex">
                        <ul class="d-flex list-unstyled mb-0 align-items-center customwidth">
                            ...
                            <li class="col pr-xl-0 px-2 px-sm-3">
                                <!-- Unfold (Dropdown) -->
                                <div class="hs-unfold">
                                    <a  class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#loginModal">
                ...
                <form class="js-validate">
                    ...
                    <div id="login">
                        ...
                        <div class="text-center mb-7">
                            <h3 class="mb-0">Ingresa en TvMia.</h3>
                        ...
                        <div class="text-center mb-3">
                            <span class="divider divider-xs divider-text">O</span>
                        </div>
                        ...
                        <div class="text-center">
                            <span class="small text-muted">¿Aun no tenes cuenta?</span>
